...
import controller.TelaAdVeiculoController;
 ...
 * @author jvton
 */
public class TelaAdVeiculo extends javax.swing.JFrame {

    private TelaAdVeiculoController controller;
    private TelaVeiculos telaVeiculos;

    /**
     * Creates new form Tela123
     */
    
    
    public TelaAdVeiculo(TelaVeiculos telaVeiculos) {
        initComponents();
        controller = new TelaAdVeiculoController(this);
        this.telaVeiculos = telaVeiculos;
        controller.arrumar_opcoes();
    }

    private TelaAdVeiculo() {
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAdVeiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAdVeiculo().setVisible(true);
            }
        });
    }
    ...
    public void setJcMarca(JComboBox<Object> jcMarca) {
